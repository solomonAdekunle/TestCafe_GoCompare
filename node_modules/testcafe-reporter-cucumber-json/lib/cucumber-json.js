...
var CucumberJsonReport = (function () {
    function CucumberJsonReport() {
        ...
        this.createDefaultStep = function (name, testRunInfo) {
            ...
            var step = __assign({}, cucumber_json_interfaces_1.testcafeDefaultStep, { name: sourceLine || 'undefined', result: {
        ...
        this.addTagsToCurrentFeature = function (tags) {
            ...
            var aggregatedTagNames = tags_parser_1.distinct(currentFeatureTagNames.concat(toBeAddedTagNames));
