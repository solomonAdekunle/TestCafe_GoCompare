...
exports.extendedReporterPlugin = {
    ...
    renderErrors: function (errs) {
        ...
        if (!Array.isArray(errs)) {
            console.warn("testcafe-reporter-cucumber-json: cannot render errors because the error object is not an array");
            ...
            console.warn("testcafe-reporter-cucumber-json :", { errs: errs });
        }
        ...
        errs.map(function (err, idx) {
            if (!err.callsite) {
                console.warn("testcafe-reporter-cucumber-json: cannot render error because the callsite object is missing in the error object");
                console.warn("testcafe-reporter-cucumber-json: please provide the following log to github.com/hdorgeval/testcafe-reporter-cucumber-json :");
            ...
            var originalStackFrames = err.callsite.stackFrames.slice();
